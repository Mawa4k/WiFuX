...
{LINE2}
  ...
  {W}MD MAWA Rahman (davil4k){RS}
  GitHub  : {C}davil4kofficial{RS}
  Website : {C}https://msrMAWA.netlify.app{RS}

{TIP} {M}Stay With davil4k — Stay safe, stay ethical.{RS}
''')
    pause()
...
def main():
    ...
    while True:
        ...
        if choice == '0':
            clear()
            print(f'\n{M}  ★ Stay With davil4k — Thanks for using WiFuX!{RS}\n')
            sys.exit(0)
